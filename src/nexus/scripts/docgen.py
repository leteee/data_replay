...
"""
    ...
    for spec in sorted_plugins:
        ...
        if plugin_context_params and spec.config_model:
            ...
            print(f"Debug: Processing model {model.__name__} from PluginContext")
            ...
            for field_name, field in model.model_fields.items():
                ...
                if hasattr(field, 'metadata'):
                    print(f"Debug: Field {field_name} has metadata: {field.metadata}")
                    for item in field.metadata:
                        if hasattr(item, '__class__') and hasattr(item, 'name'):
                            print(f"Debug: Found annotation {item.__class__.__name__} with name {getattr(item, 'name', '')}")
            ...
            # Debug information
            print(f"Debug: Found {len(data_sources)} data sources and {len(data_sinks)} data sinks for {model.__name__}")
            ...
            if data_sources:
                ...
                for source in data_sources:
                    print(f"Debug: Data source - {source}")  # Debug print
            ...
            if data_sinks:
                ...
                for sink in data_sinks:
                    print(f"Debug: Data sink - {sink}")  # Debug print
